...
export default function UserProfileCard({ user }) {
  ...
  return (
    <section className="flex flex-col gap-5 rounded-2xl border border-[#e3ece8] bg-white p-5 shadow-[0_1px_2px_rgba(16,24,20,0.04)] sm:p-6">
      ...
      <div className="flex flex-wrap gap-x-6 gap-y-2 border-t border-[#eef2f0] pt-4 text-xs text-[#6b7b74]">
